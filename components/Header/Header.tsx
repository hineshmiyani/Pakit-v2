    ...
    <header className="header">
      ...
      <Link href="/welcome">
        <Box sx={styles.logoContainer}>
          <Image src="/asset/images/pakitLogo.png" height={34} width={34} className="object-cover" alt="" />
      ...
      <Box sx={styles.accountContainer}>
        ...
        <Stack>
          ...
          <Stack direction="row" alignItems="center" spacing="8px">
            <Image src="/asset/images/avatar.png" alt="" width={12} height={12} className="rounded-full object-cover" />
